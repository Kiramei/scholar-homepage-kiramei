module.exports = {
  ...
  safelist: {
    ...
    // academic-motion.js adds these classes at runtime. A greedy rule keeps the
    // complete compound selectors, including html[data-motion="active"].
    greedy: [/motion-(?:reveal|visible)/],
  },
};
